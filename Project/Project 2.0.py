...
def new():
    ...
    productname1=Label(newWindow, text="Porsche Taycan Turbo S", font=("Playfair Display", 11), fg="White")
    productname1.grid(column=0, row=3, columnspan=2, padx=5, sticky=W)

    productname2=Label(newWindow, text="Nissan GT-R Black Edition", font=("Playfair Display", 11), fg="White")
    productname2.grid(column=2, row=3, columnspan=2, padx=5, sticky=W)

    productname3=Label(newWindow, text="Mercedes-AMG GT-R", font=("Playfair Display", 11), fg="White")
    productname3.grid(column=4, row=3, columnspan=2, padx=5, sticky=W)

    productname4=Label(newWindow, text="Acura NSX", font=("Playfair Display", 11), fg="White")
    productname4.grid(column=6, row=3, columnspan=2, padx=5, sticky=W)

    #Row 4 Product Price Label
    productprice1=Label(newWindow, text="185,000 CR", font=("Playfair Display", 10), fg="White")
    productprice1.grid(column=0, row=4, padx=5, sticky=W)

    productprice2=Label(newWindow, text="250,000 CR", font=("Playfair Display", 10), fg="White")
    productprice2.grid(column=2, row=4, padx=5, sticky=W)

    productprice3=Label(newWindow, text="295,000 CR", font=("Playfair Display", 10), fg="White")
    productprice3.grid(column=4, row=4, padx=5, sticky=W)

    productprice4=Label(newWindow, text="170,000 CR", font=("Playfair Display", 10), fg="White")
