...
# 建立 MIMEText 物件
text = MIMEText("Demo-我是一封來自Python的Email")
image = MIMEImage(Path("/Users/Louie/Documents/Python_2023Spring/Class1/logo_tree.png").read_bytes())

# 創建並設定 MIMEMultipart 物件
content = MIMEMultipart() # 建立 MIMEMultipart 物件
content["subject"] = "2023 Python App 創新程式春季班 《Demo》" # 郵件標題
content["from"] = "louiechiang907@gmail.com" # 寄件者
content["to"] = "louie@chiang1.com" # 收件者
